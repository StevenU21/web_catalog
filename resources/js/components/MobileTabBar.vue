...
// Simple route matching logic for active state
...
<template>
    <!-- Tab Bar -->
    <div class="md:hidden fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-md border-t border-[#DAB6C4]/30 z-[45] pb-safe shadow-[0_-4px_20px_rgba(0,0,0,0.05)]">
